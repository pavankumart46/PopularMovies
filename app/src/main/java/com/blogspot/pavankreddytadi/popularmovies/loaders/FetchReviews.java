...
public class FetchReviews extends AsyncTaskLoader<String>
{
    ...
    public FetchReviews(Context context,long id)
    {
        super(context);
        this.id = id;
    }
    ...
    {
        Uri uri = Uri.parse(BASE_URL_VIDEOS+""+id+"/reviews?api_key="+API_KEY);
        try {
